...
export const rumorStatusEnum = pgEnum("rumor_status", ["active", "verified", "debunked", "inconclusive"]);
...
export const insertVoteSchema = createInsertSchema(evidenceVotes).omit({
  id: true,
  createdAt: true,
